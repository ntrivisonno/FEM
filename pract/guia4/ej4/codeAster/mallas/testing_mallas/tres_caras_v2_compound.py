...
Compound_1 = geompy.MakeCompound([cuad_chico, cuad_2, cuad_1])
...
listSubShapeIDs = geompy.SubShapeAllIDs(Compound_1, geompy.ShapeType["EDGE"])
listSubShapeIDs = geompy.SubShapeAllIDs(Compound_1, geompy.ShapeType["EDGE"])
fijacion = geompy.CreateGroup(Compound_1, geompy.ShapeType["EDGE"])
geompy.UnionIDs(fijacion, [24])
laterales_largos = geompy.CreateGroup(Compound_1, geompy.ShapeType["EDGE"])
geompy.UnionIDs(laterales_largos, [19, 27, 14, 31])
laterales_cortos = geompy.CreateGroup(Compound_1, geompy.ShapeType["EDGE"])
geompy.UnionIDs(laterales_cortos, [17, 21, 7])
simil_fij = geompy.CreateGroup(Compound_1, geompy.ShapeType["EDGE"])
geompy.UnionIDs(simil_fij, [9, 4])
...
geompy.addToStudyInFather( Compound_1, fijacion, 'fijacion' )
geompy.addToStudyInFather( Compound_1, laterales_largos, 'laterales_largos' )
geompy.addToStudyInFather( Compound_1, laterales_cortos, 'laterales_cortos' )
geompy.addToStudyInFather( Compound_1, simil_fij, 'simil_fij' )
