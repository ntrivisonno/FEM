...
listSubShapeIDs = geompy.SubShapeAllIDs(cuad_2, geompy.ShapeType["EDGE"])
listSubShapeIDs = geompy.SubShapeAllIDs(cuad_2, geompy.ShapeType["EDGE"])
[geomObj_10,geomObj_11,geomObj_12,geomObj_13] = geompy.ExtractShapes(cuad_2, geompy.ShapeType["EDGE"], True)
[Vertex_13,Vertex_14,Vertex_15,Vertex_16] = geompy.ExtractShapes(cuad_2, geompy.ShapeType["VERTEX"], True)
listSubShapeIDs = geompy.SubShapeAllIDs(cuad_2, geompy.ShapeType["VERTEX"])
listSubShapeIDs = geompy.SubShapeAllIDs(cuad_2, geompy.ShapeType["VERTEX"])
listSubShapeIDs = geompy.SubShapeAllIDs(cuad_2, geompy.ShapeType["VERTEX"])
listSubShapeIDs = geompy.SubShapeAllIDs(cuad_2, geompy.ShapeType["VERTEX"])
...
listSubShapeIDs = geompy.SubShapeAllIDs(cuad_2, geompy.ShapeType["VERTEX"])
listSubShapeIDs = geompy.SubShapeAllIDs(cuad_2, geompy.ShapeType["VERTEX"])
listSubShapeIDs = geompy.SubShapeAllIDs(Vertex_15, geompy.ShapeType["VERTEX"])
listSubShapeIDs = geompy.SubShapeAllIDs(Vertex_15, geompy.ShapeType["VERTEX"])
listSubShapeIDs = geompy.SubShapeAllIDs(Vertex_15, geompy.ShapeType["VERTEX"])
listSubShapeIDs = geompy.SubShapeAllIDs(Vertex_15, geompy.ShapeType["VERTEX"])
listSubShapeIDs = geompy.SubShapeAllIDs(Vertex_15, geompy.ShapeType["VERTEX"])
...
despl = geompy.CreateGroup(cuad_2, geompy.ShapeType["VERTEX"])
geompy.UnionIDs(despl, [5])
...
geompy.addToStudyInFather( cuad_2, Vertex_13, 'Vertex_13' )
geompy.addToStudyInFather( cuad_2, Vertex_14, 'Vertex_14' )
geompy.addToStudyInFather( cuad_2, Vertex_15, 'Vertex_15' )
geompy.addToStudyInFather( cuad_2, Vertex_16, 'Vertex_16' )
...
geompy.addToStudyInFather( cuad_2, despl, 'despl' )
...
dx_cuad_chic = Regular_1D.LocalLength(1,None,1e-07)
Regular_1D_1 = Mesh_1.Segment(geom=cuad_chic_Y)
dy_cuad_chic = Regular_1D_1.LocalLength(1,None,1e-07)
isDone = Mesh_1.Compute()
[ cuad_chic_X_1, cuad_chic_Y_1 ] = Mesh_1.GetGroups()
...
cuad_2_X_1 = Mesh_2.GroupOnGeom(cuad_2_X,'cuad_2_X',SMESH.EDGE)
cuad_2_Y_1 = Mesh_2.GroupOnGeom(cuad_2_Y,'cuad_2_Y',SMESH.EDGE)
despl_1 = Mesh_2.GroupOnGeom(despl,'despl',SMESH.NODE)
Regular_1D_2 = Mesh_2.Segment(geom=cuad_2_X)
dx_cuad_2 = Regular_1D_2.LocalLength(1,None,1e-07)
Regular_1D_3 = Mesh_2.Segment(geom=cuad_2_Y)
status = Mesh_2.AddHypothesis(dy_cuad_chic,cuad_2_Y)
isDone = Mesh_2.Compute()
[ cuad_2_X_1, cuad_2_Y_1, despl_1 ] = Mesh_2.GetGroups()
Mesh_3 = smesh.Mesh(cuad_1)
status = Mesh_3.AddHypothesis(Quadrangle_Parameters_1)
...
status = Mesh_3.AddHypothesis(dx_cuad_chic,Fixa)
Regular_1D_5 = Mesh_3.Segment(geom=Cuad_1_X)
status = Mesh_3.AddHypothesis(dx_cuad_chic,Cuad_1_X)
Regular_1D_6 = Mesh_3.Segment(geom=Cuad_1_Y)
status = Mesh_3.AddHypothesis(dx_cuad_2,Cuad_1_Y)
isDone = Mesh_3.Compute()
[ Fixa_1, Cuad_1_X_1, Cuad_1_Y_1 ] = Mesh_3.GetGroups()
malla_ej4 = smesh.Concatenate([Mesh_1.GetMesh(), Mesh_2.GetMesh(), Mesh_3.GetMesh()], 1, 1, 1e-05)
#malla_ej4.RemoveGroup( smeshObj_1 ) ### smeshObj_1 has not been yet created
#malla_ej4.RemoveGroup( smeshObj_2 ) ### smeshObj_2 has not been yet created
#malla_ej4.RemoveGroup( smeshObj_3 ) ### smeshObj_3 has not been yet created
#malla_ej4.RemoveGroup( smeshObj_4 ) ### smeshObj_4 has not been yet created
#malla_ej4.RemoveGroup( smeshObj_5 ) ### smeshObj_5 has not been yet created
smesh.SetName(malla_ej4, 'malla_ej4')
try:
  malla_ej4.ExportMED( r'/home/zeeburg/Documents/CIMEC/Cursos/FEM/pract/guia4/ej4/codeAster/malla_ej4.med', 1, SMESH.MED_V2_2, 1, None ,1)
except:
...
Sub_mesh_7 = Regular_1D_6.GetSubMesh()
...
smesh.SetName(despl_1, 'despl')
smesh.SetName(dx_cuad_chic, 'dx_cuad_chic')
smesh.SetName(dy_cuad_chic, 'dy_cuad_chic')
smesh.SetName(Quadrangle_Parameters_1, 'Quadrangle Parameters_1')
smesh.SetName(dx_cuad_2, 'dx_cuad_2')
...
smesh.SetName(malla_ej4.GetMesh(), 'malla_ej4')
