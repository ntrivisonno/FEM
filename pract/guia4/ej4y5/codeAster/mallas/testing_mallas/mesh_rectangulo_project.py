...
Quadrangle_Parameters_1 = Quadrangle_2D.QuadrangleParameters(StdMeshersBuilder.QUAD_QUADRANGLE_PREF,None,[],[])
Regular_1D = Mesh_1.Segment(geom=carga)
carga_1 = Regular_1D.NumberOfSegments(10,1,[])
Regular_1D_1 = Mesh_1.Segment(geom=lado_larg)
lado_larg_1 = Regular_1D_1.NumberOfSegments(15,0.1,[])
Regular_1D_2 = Mesh_1.Segment(geom=lado_cort)
lado_cort_1 = Regular_1D_2.NumberOfSegments(15,0.2,[])
...
[ carga_2, lado_larg_2, lado_cort_2 ] = Mesh_1.GetGroups()
carga_1.SetNumberOfSegments( 10 )
carga_1.SetScaleFactor( 0.2 )
carga_1.SetReversedEdges( [] )
