...
[ largo_X_1, largo_Y_1, fijacion_1, carga_3 ] = Mesh_1.GetGroups()
largo_X_2.SetNumberOfSegments( 15 )
largo_X_2.SetScaleFactor( 5 )
largo_X_2.SetReversedEdges( [] )
largo_Y_2.SetNumberOfSegments( 15 )
largo_Y_2.SetScaleFactor( 2 )
largo_Y_2.SetReversedEdges( [] )
carga_2.SetNumberOfSegments( 15 )
carga_2.SetScaleFactor( 2 )
carga_2.SetReversedEdges( [] )
Regular_1D_3 = Mesh_1.Segment(geom=carga_1)
Number_of_Segments_1 = Regular_1D_3.NumberOfSegments(15,2,[])
[ largo_X_1, largo_Y_1, fijacion_1, carga_3 ] = Mesh_1.GetGroups()
isDone = Mesh_1.Compute()
[ largo_X_1, largo_Y_1, fijacion_1, carga_3 ] = Mesh_1.GetGroups()
[ bad_mesh_of_Face_1_0 ] = smesh.MakeGroupsOfBadInputElements( Mesh_1, 1, 'bad mesh of Face_1 (Face_1)' )
...
smesh.SetName(bad_mesh_of_Face_1_0, 'bad mesh of Face_1 (0:1:1:23)')
