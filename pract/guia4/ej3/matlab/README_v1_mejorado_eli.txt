...
mtl2vtu('pp.vtu',xx,struct('Connectivity',conec,'Type','TRI3'),u)

para plotear la deformada

$ a=10;pp=a*reshape(u',2,[])'+xx(:,1:2);close all;pltmsh3(in,pp,iel,conec);print -dpng figs/fig.png
...
% Abaqus | triang cuad -> 6 nodos 12 GDL 


%Datos de Desplazamientos
malla_ej3a_0g 130 GDL.txt  -> 6x2 elem
n_central =  | ux()  =  | uy()  =0.0731 | uy*E*t/P = 109.6643
malla_ej3a_182 GDL.txt  -> 6x3 elem
n_central =  | ux()  =  | uy()  = 0.0754| uy*E*t/P = 113.1147
malla_ej3a_238 GDL.txt -> 8x3 elem
n_central = | ux() =  | uy() = 0.0757 | uy*E*t/P = 113.5648
malla_ej3a_306 GDL.txt -> 8x4 elem
n_central = | ux() =  | uy() = 0.0764 | uy*E*t/P = 114.6149


% Abaqus | cuad lineal -> 4 nodos 8 GDL
malla_1_56 GDL -> 6x3 elem
n_central = 28 | ux()  = -3.0114e-13| uy() = 0.0551 | uy*E*t/P = 82.661

malla_2_84 GDL -> 6x4 elem
n_central = 28 | ux()  = 0.015700   | uy() = 0.0673 | uy*E*t/P = 100.96
	  
malla_3_98 GDL   -> 6x6 elem
n_central = 28 | ux()  = 8.1376e-13 | uy() = 0.0700 | uy*E*t/P = 105.01

malla_4_140GDL -> 6x9 elem
n_central = 40 | ux()  = 1.7024e-7  | uy() = 0.0738 | uy*E*t/P = 110.71

malla_5_216GDL -> 8x11 elem
n_central = 60 | ux() = 7.1424e-17  | uy() = 0.0750 | uy*E*t/P = 112.51 

malla_6_252GDL -> 8x13 elem
n_central = 70 | ux() = -4.4721e-17 | uy() = 0.0757 | uy*E*t/P = 113.56


% Abaqus | cuad cuad -> 8 nodos 16 GDL
malla 66 GDL -> 6x1 elem
