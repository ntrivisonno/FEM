function pltmsh6rotu(in,xx,iel,conec,u,locel,fac)
% function pltmsh6rotu(in,xx,iel,conec,u,locel,fac)
%
%   Dibuja una malla de elementos finitos triangulares de 6 nodos
%
%   in:    Numeros de nodos
...
%
    ...
    for i=1:nel
        plot( [X1(i,1) X1(i,4) X1(i,2) X1(i,5) X1(i,3) X1(i,6) X1(i,1)], ...
              [Y1(i,1) Y1(i,4) Y1(i,2) Y1(i,5) Y1(i,3) Y1(i,6) Y1(i,1)], '-b');
        plot( [X1(i,1) X1(i,4) X1(i,2) X1(i,5) X1(i,3) X1(i,6)], ...
              [Y1(i,1) Y1(i,4) Y1(i,2) Y1(i,5) Y1(i,3) Y1(i,6)], '.b')
    end
