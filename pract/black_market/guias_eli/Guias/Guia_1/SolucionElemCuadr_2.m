...
%              u(dom(1)) = u(dom(2)) = 0
% Elementos finitos cuadráticos (funciona para 2 o más elementos).
...
% s_f: es la fuerza aplicada en simbólico en función de x.
   ...
   x0 = m_dom(1);
   l = m_dom(2)-x0;
   %Se considera una distribución uniforme de los elementos y del nodo central.
   lIk = l/n;
...
% Devuelve una función que toma por argumento (xk1,xk2,xk3) y devuelve un vector de fuerzas
% m_b: m_b=f_b(xk1,xk2,xk3).
   ...
   %Se transforma la función de fuerza en coordenadas locales (~x).
