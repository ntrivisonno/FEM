...
%
    ...
    [row,col,sk] = stiffcurElast2D_1(xx,iel,conec,locel,inn,indof,t,E,nu);  
     ...
     elseif  eltype==6,   %Stoke 2D Elasticidad
         
    [row,col,sk] = stiffcurStokes (in,xx,iel,conec,locel,inn,indof,inel,t,E,nu);
    
    elseif  eltype==7,   %Morley 2D Elasticidad
         
    [row,col,sk] = stiffcurMorley (in,xx,iel,conec,locel,inn,indof,inel,t,E,nu);
