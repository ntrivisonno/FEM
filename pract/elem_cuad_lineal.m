function [phi_all,phi_all_areas] = elem_cuad_lineal()
  % ------------------------------------------------
  % CONTINUAR DESARROLLANDO EL ARCHIVO .m, la idea es a partir de la func elem triang cuad, hacer lo mismo para un elem cuad
  % ------------------------------------------------
