...
%  inn:   Vector de nodos ordenados de manera decresiente
...
for ele = 1:nel
    ...
    for k=1:3 % np recupera con las conectividades y las cordenadas, te da las cordenadas de todas las coordenadas del elem
      %s
