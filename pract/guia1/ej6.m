...
Aphi1 = subs(subs(subs(subs(subs(subs(A,x1,0),x2,h),x3,0),y1,0),y2,0),y3,h);
...
phi2=subs(subs(subs(phi2,x1,0),x2,h),x3,0);     % phi1
phi3=subs(subs(subs(phi3,x1,0),x2,h),x3,0);     % phi1
