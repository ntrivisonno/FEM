...
%
    ...
    else eltype=6;  %Elemento triangular isoparametrico
        [row,col,sk,MR_s,qrob,qneu_s] = stiffcurIsoQuad (in,xx,iel,conec,locel,inn,indof,inel,Vect_Mat,Kt,Elem_Neumann,Elem_Robin,Mat_Nod_Neu,h_rob,t_ref,Num_Nod_Neu);
    end
